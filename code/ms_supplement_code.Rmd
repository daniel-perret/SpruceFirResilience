...
```{r}
ind.mort.dat <- read.csv("data/mortdat.csv",header=T) # for survival model
seed.dat <- read.csv("data/seeddat.csv",header=T) # for regeneration model
sap.dat <- read.csv("data/sapdat.csv",header=T) # for recruitment model
```
