...
```{r}
ind.mort.dat <- read.csv("mortdat.csv",header=T) # for survival model
seed.dat <- read.csv("seeddat.csv",header=T) # for regeneration model
sap.dat <- read.csv("sapdat.csv",header=T) # for recruitment model
```
